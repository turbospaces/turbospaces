...
import com.elsecloud.api.EmbeddedJSpaceRunner;
...
public class TestEntity1 implements InitializingBean, Cloneable {
    ...
    public SpaceOperation[] spaceOperations;
    ...
    public void afterPropertiesSet() {
        ...
        spaceOperation = SpaceOperation.EXCLUSIVE_READ_LOCK;
    ...
    public SpaceOperation[] getSpaceOperations() {
        return spaceOperations;
    }

    public void setSpaceOperations(final SpaceOperation[] spaceOperations) {
    ...
    public void assertMatch(final TestEntity1 data2) {
        ...
        assertThat( data2.getSpaceOperation(), is( getSpaceOperation() ) );
        assertThat( data2.getAutowire(), is( getAutowire() ) );
        assertThat( data2.getSpaceOperations(), is( getSpaceOperations() ) );
    ...
    public static SpaceConfiguration configurationFor()
        ...
        configuration.setKryo( SpaceUtility.spaceKryo( configuration, null ) );
