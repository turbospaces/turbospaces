 ...
 * </p>
 * 
 * For convenience class provides {@link #destroy()} method which removes all objects from pool.</p>
 * 
 ...
 */
@ThreadSafe
public class SimpleObjectPool<T> implements ObjectPool<T>, DisposableBean {
    /**
     ...
     * @param objFactory
     */
    public SimpleObjectPool(final com.elsecloud.pool.ObjectFactory<T> objFactory) {
        super();
