...
import com.elsecloud.logging.JGroupsCustomLoggerFactory;
...
public class EmbeddedJSpaceRunner {
    ...
    public static void main(final String... args)
        ...
        LOGGER.info( "Welcome to elsecloud version = {}, build date = {}", SpaceUtility.projectVersion(), SpaceUtility.projecBuildTimestamp() );
