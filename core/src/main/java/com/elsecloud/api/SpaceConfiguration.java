...
import com.elsecloud.network.SpaceNetworkServiceProvider;
...
/**
 * This is the server side {@link JSpace} configuration placeholder. Important consideration is that elsecloud relies
...
public final class SpaceConfiguration extends AbstractSpaceConfiguration {
    ...
    public void afterPropertiesSet()
        ...
        dispatcher = new ServerCommunicationDispatcher( getJChannel(), getDefaultCommunicationTimeoutInMillis() );
