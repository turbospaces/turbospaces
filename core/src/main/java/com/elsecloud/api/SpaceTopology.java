...
public enum SpaceTopology {
     ...
     * 
     * Also <b>NOTE:</b> that from elsecloud experience typical application will have few spaces defined with different
     * deployment topologies (sync_repl and partitioned) where partitioned space is placeholder for 'big data' and
     * replicated is placeholder for reference data source(dictionaries).
     */
    SYNC_REPLICATED,
    /**
