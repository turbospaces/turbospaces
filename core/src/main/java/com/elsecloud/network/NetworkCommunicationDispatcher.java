...
import com.elsecloud.core.SimpleRequestResponseCorrelator;
...
public final class NetworkCommunicationDispatcher extends ServerCommunicationDispatcher implements SpaceErrors {
     ...
     */
    public NetworkCommunicationDispatcher(final JChannel jChannel, final long communicationTimeout) {
        super( jChannel, communicationTimeout );
    }
    ...
    public MethodCall[] sendAndReceive(final MethodCall methodCall,
        ...
        for ( int i = 0; i < size; i++ ) {
            ...
            result[i] = requestResponseCorrelator.responseFor( id, monitor, communicationTimeout );
        }
