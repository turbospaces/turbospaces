 ...
 * constructor making outer initialization impossible. See {@link ByteArrayPointer} for concrete usage example.
 * 
 * @since 0.1
 * @param <T>
...
public interface ObjectPool<T> {
     ...
     * 
     * @param obj
     *            object that has been borrowed and no longer needed
     */
